function [yy,xx] = createFit_nBin(xf,n,marker,color)
...
% This function was automatically generated on 08-Sep-2021 11:27:28
...
BinInfo.rule = 3;
BinInfo.nbins = n;    % set the n of bins you need
[~,BinEdge] = internal.stats.histbins(xf,[],[],BinInfo,CdfF,CdfX);
[BinHeight,BinCenter] = ecdfhist(CdfF,CdfX,'edges',BinEdge);
hLine = plot(BinCenter,BinHeight);
set(hLine,'LineStyle','none', 'Marker',marker,'Markersize',7,'color',color);
xlabel('Data');
ylabel('Density')
